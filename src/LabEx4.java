...
public class LabEx4 {
    ...
    public static void main(String[] args) {
        ...
        if (t == 1) {
            ...
            String[] inserts = {"F", "T", "D", "Q", "A", "L", "E", "P", "S", "M", "H", "C"};
            for (String val : inserts) {
                bst1.insert(val);
            }
            System.out.println(bst1);

            String[] searches = {"R", "A", "F", "L", "N", "D", "V"};
            for (String key : searches) {
                BTNode<String> result = bst1.search(key);
                if (result != null) {
                    System.out.println("Found: " + key + " at level " + result.level);
                } else {
